...
class Player:
    ...
    def _parseMetadata(self):
        if self._metadata != None:
            ...
            _nwoplaying = _getProperty(self._metadata, 'xesam:contentCreated', '')
            # Update metadata
            ...
            _player                     = self.bus_name.split('.')[3]
            self.metadata['player']     = _player
            self.metadata['nowplaying']   = _getProperty(self._metadata, '{}:nowplaying'.format(_player), '')
