...
warning_bg_color = rgba_to_hex(
    style_context.lookup_color('warning_bg_color')[1])
warning_fg_color = rgba_to_hex(
    style_context.lookup_color('warning_fg_color')[1])
text_color = rgba_to_hex(style_context.lookup_color('theme_text_color')[1])
borders = rgba_to_hex(style_context.lookup_color(
    'theme_unfocused_fg_color')[1])


print('rofi.color-window: ' + bg_color + ", " + borders + ", " + borders)
print('rofi.color-normal: ' + bg_color + ", " + fg_color + ", " +
      bg_color + ", " + selected_bg_color + ", " + selected_fg_color)
print('rofi.color-active: ' + bg_color + ", " + fg_color + ", " +
      bg_color + ", " + warning_bg_color + ", " + warning_fg_color)
print('rofi.color-urgent: ' + bg_color + ", " + fg_color + ", " +
      bg_color + ", " + error_bg_color + ", " + error_fg_color)
